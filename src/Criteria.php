...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'tenant_id', 'user_id', 'channel', 'template', 'status', 'retries', 'max_retries', 'next_attempt_at', 'scheduled_at', 'sent_at', 'error', 'last_attempt_at', 'locked_until', 'locked_by', 'priority', 'created_at', 'updated_at', 'version' ];
