...
namespace BlackCat\Database\Packages\Notifications\Mapper;

use BlackCat\Database\Packages\Notifications\Dto\NotificationDto;
use BlackCat\Database\Packages\Notifications\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO NotificationDto:
...
final class NotificationDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'user_id', 'retries', 'max_retries', 'priority', 'version' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'payload' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'next_attempt_at', 'scheduled_at', 'sent_at', 'last_attempt_at', 'locked_until', 'created_at', 'updated_at' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): NotificationDto
    {
        /** @var NotificationDto */
    ...
    public static function fromRowOrNull(?array $row): ?NotificationDto
    {
     ...
     */
    public static function toRow(NotificationDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(NotificationDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(NotificationDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(NotificationDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,NotificationDto>
     */
