...
- Pkg folder: [packages\notifications](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\notifications)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package notifications -Apply
