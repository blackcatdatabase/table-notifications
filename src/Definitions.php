...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'user_id', 'channel', 'template', 'payload', 'status', 'retries', 'max_retries', 'next_attempt_at', 'scheduled_at', 'sent_at', 'error', 'last_attempt_at', 'locked_until', 'locked_by', 'priority', 'created_at', 'updated_at', 'version' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'user_id', 'retries', 'max_retries', 'priority', 'version' ]; }
